# Delivery — Session Starter

## Product
- Name: Delivery
- Product ID / Assembly IDs: A-006
- Owner Session: Delivery Owner — Lyra

## Scope
- Owns: Product-specific planning, execution discipline, and artifacts for delivery.
