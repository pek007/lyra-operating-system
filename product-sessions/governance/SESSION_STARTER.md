# Governance — Session Starter

## Product
- Name: Governance
- Product ID / Assembly IDs: A-002
- Owner Session: Governance Owner — Lyra

## Scope
- Owns: Product-specific planning, execution discipline, and artifacts for governance.
