# Task Management — Session Starter

## Product
- Name: Task Management
- Product ID / Assembly IDs: A-001
- Owner Session: Task Management Owner — Lyra

## Scope
- Owns: Product-specific planning, execution discipline, and artifacts for task management.
