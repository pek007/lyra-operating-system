# Improvement — Session Starter

## Product
- Name: Improvement
- Product ID / Assembly IDs: A-005
- Owner Session: Improvement Owner — Lyra

## Scope
- Owns: Product-specific planning, execution discipline, and artifacts for improvement.
