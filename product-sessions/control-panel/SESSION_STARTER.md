# Control Panel — Session Starter

## Product
- Name: Control Panel
- Product ID / Assembly IDs: P-001
- Owner Session: Control Panel Owner — Lyra

## Scope
- Owns: Product-specific planning, execution discipline, and artifacts for control panel.
