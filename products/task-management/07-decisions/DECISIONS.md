...
### D-008 — First Delivery / TDE / PXS Tools proving case uses CRM Core Slice 1 as a machine-execution support loop, not a primary implementation path
...
- `07-decisions/TDE_FORMATION_TO_CANONICAL_CREATION_MAPPING_V1.md`
- `07-decisions/TDE_REQUEST_ENTRY_WORKFLOW_V1.md`
- `07-decisions/TDE_REQUEST_ENTRY_RESULT_ARTIFACT_V1.md`
