...
## Decision A-004-D1 — Activate A-004 as the Security product
...
- Decision: Use `products/A-004/management/` as the canonical management pack for the Security product and treat this session/thread as the operating channel for Security product work.
- Trade-offs:
...
## Decision A-004-D2 — Security owns controls, posture, and security research conversion; it does not own all execution
...
## Decision A-004-D3 — Keep Peter informed on material security decisions; execute routine product work autonomously
