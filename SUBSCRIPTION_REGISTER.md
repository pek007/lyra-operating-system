...
|---|---|---|---|---:|---|---|---|---|---|---|---|---|
| Brave Search API | Research API | Peter | Search API | TBD | Monthly | 2026-03-26 (review) | Enable live web research in OpenClaw | `web_search` calls/day | Baseline started 2026-02-24 (`BRAVE_USAGE_BASELINE_2026-03.md`) | Review in 30 days | No | Brave dashboard > API billing/subscription |
